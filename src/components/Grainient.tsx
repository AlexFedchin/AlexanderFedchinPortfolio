...
/**
 * Grainient — an animated, grainy, warped-gradient WebGL background.
 * Ported to TypeScript from the React Bits component and tuned for a
 * monochrome (black/white) palette with a subtle cyan glow.
 */
