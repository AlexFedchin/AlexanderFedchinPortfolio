...
const features = [
  ...
  },
  {
    icon: Palette,
    title: "UI/UX Design",
    description: "Creating intuitive interfaces with pixel-perfect attention to detail.",
  },
  {
    icon: Zap,
    title: "Performance",
  ...
  return (
    <section id="about" className="relative py-32 overflow-hidden">
      ...
      <div className="container relative z-10 px-6">
        ...
        >
          <h2 className="text-sm font-mono text-primary mb-4 tracking-wider">// ABOUT ME</h2>
          <h3 className="text-4xl md:text-5xl font-bold mb-6">
            Passionate about <span className="gradient-text">crafting</span> digital experiences
          </h3>
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
            With years of experience in frontend development, I specialize in building 
            modern web applications that combine beautiful design with exceptional performance.
          </p>
        </motion.div>
